...
//详情页 - 物品详情
const detailGoods = require('./detail/goods.js')
router.get('/api/detail/goods/:id', function *(next) {
    // console.log('详情页 - 商户信息')
...
router.get('/api/orderlist/:username/:page', function *(next) {
    console.log('订单列表')
